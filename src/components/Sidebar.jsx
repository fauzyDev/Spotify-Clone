...
const Sidebar = ({ view, setView, setPlaylistId }) => {
    ...
    return(
        <div className="w-64 text-neutral-400 grow-0 shrink-0 h-screen overflow-y-scroll overflow-x-hidden border-r border-neutral-900 p-5 text-sm hidden sm:inline-flex">
            ...
            {playlists?.map((playlist) => {
              return (
                  <div 
                    ...
                    key={playlist.id} 
                    className="flex items-center cursor-default hover:text-white w-52 truncate my-2 space-x-2">
                    <Image className="h-12 w-12" src={playlist.images[0].url} alt="playlist" width={50} height={50} />
